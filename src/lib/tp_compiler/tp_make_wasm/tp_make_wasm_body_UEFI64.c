...
#define TP_WASM_MODULE_SECTION_CODE_LOCAL_COUNT 2
#define TP_WASM_MODULE_SECTION_CODE_VAR_COUNT_I64 2
#define TP_WASM_MODULE_SECTION_CODE_VAR_COUNT_I32 1
...
TP_WASM_MODULE_SECTION* tp_make_section_code_origin_wasm_UEFI64(TP_SYMBOL_TABLE* symbol_table)
{
    ...
    if ( ! tp_wasm_add_global_variable_i64(
        ...
        EFI_SUCCESS, SYMBOL_OF_EFI_SUCCESS, SYMBOL_LENGTH_OF_EFI_SUCCESS,
    ...
    if ( ! tp_wasm_add_global_variable_i64(
        symbol_table, is_external,
        ST, SYMBOL_OF_ST, SYMBOL_LENGTH_OF_ST,
    ...
    if ( ! tp_wasm_add_global_variable_i64(
        symbol_table, is_external,
        RT, SYMBOL_OF_RT, SYMBOL_LENGTH_OF_RT,
    ...
    if ( ! tp_wasm_add_global_variable_i64(
        symbol_table, is_external,
        IN_, SYMBOL_OF_IN, SYMBOL_LENGTH_OF_IN,
    ...
    if ( ! tp_wasm_add_global_variable_i64(
        symbol_table, is_external,
        OUT_, SYMBOL_OF_OUT, SYMBOL_LENGTH_OF_OUT,
    ...
    if ( ! tp_wasm_add_function(
        symbol_table, is_external,
        TP_WASM_UEFI_ENTRY_POINT, TP_WASM_UEFI_ENTRY_POINT_LENGTH, NULL)){
    ...
    TP_SYMBOL_TABLE* symbol_table, uint8_t* section_buffer, size_t* body_size)
{
    ...
    uint32_t var_count_i64 = TP_WASM_MODULE_SECTION_CODE_VAR_COUNT_I64;
    ...
    uint32_t var_local_index_base = 2;
    uint32_t var_local_index_i64 = var_local_index_base + 1;

    uint32_t var_count_i32 = TP_WASM_MODULE_SECTION_CODE_VAR_COUNT_I32;
    ...
    uint32_t var_local_index_i32 = var_local_index_base + 2;
    ...
    TP_WASM_CODE_ARG(
        symbol_table, index, tp_make_get_local_code(
            section_buffer, index, 1
        ), TP_WASM_ARG_INDEX_EDX,
        TP_WASM_MODULE_SECTION_TYPE_RETURN_TYPE_I64,
        false/* is_containing_function_call */
    );
    TP_WASM_CODE(
    ...
    TP_WASM_CODE_CALL(
        ...
        ), TP_WASM_ARG_INDEX_VOID, TP_WASM_MODULE_SECTION_TYPE_RETURN_TYPE_I64, 0
    );
