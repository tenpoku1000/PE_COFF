...
#define TP_WASM_MODULE_SECTION_GLOBAL_TYPE_I64 0x7e
...
TP_WASM_MODULE_SECTION* tp_make_section_type_UEFI(TP_SYMBOL_TABLE* symbol_table)
{
    ...
    uint32_t param_types_1_1 = TP_WASM_MODULE_SECTION_TYPE_PARAM_TYPE_I64;
    uint32_t param_types_1_2 = TP_WASM_MODULE_SECTION_TYPE_PARAM_TYPE_I64;
    ...
    TP_WASM_SECTION_TYPE_VAR* wasm_types =
        (TP_WASM_SECTION_TYPE_VAR*)TP_CALLOC(
            symbol_table, count, sizeof(TP_WASM_SECTION_TYPE_VAR)
        );
    ...
    symbol_table->member_wasm_type_count = count;

    uint32_t* param_types_1 = (uint32_t*)TP_CALLOC(symbol_table, param_count_1, sizeof(uint32_t));

    if (NULL == param_types_1){
    ...
    param_types_1[0] = param_types_1_1;
    param_types_1[1] = param_types_1_2;

    symbol_table->member_wasm_types[0] =
        (TP_WASM_SECTION_TYPE_VAR){
            .member_form = form,
            .member_param_count = param_count_1,
            .member_param_types = param_types_1,
            .member_return_count = return_count,
            .member_return_type = return_type
        };

    uint32_t* param_types_2 = (uint32_t*)TP_CALLOC(symbol_table, param_count_2, sizeof(uint32_t));

    if (NULL == param_types_2){
    ...
    param_types_2[0] = param_types_2_1;
    param_types_2[1] = param_types_2_2;
    param_types_2[2] = param_types_2_3;
    param_types_2[3] = param_types_2_4;

    symbol_table->member_wasm_types[1] =
        (TP_WASM_SECTION_TYPE_VAR){
            .member_form = form,
            .member_param_count = param_count_2,
            .member_param_types = param_types_2,
            .member_return_count = return_count,
            .member_return_type = return_type
        };
    ...
    uint32_t heap_current, uint32_t heap_base, uint32_t data_end)
{
    ...
    uint32_t content_type_1 = TP_WASM_MODULE_SECTION_GLOBAL_TYPE_I64;
    uint32_t mutability_1 = TP_WASM_MODULE_SECTION_GLOBAL_MUTABLE;
    uint32_t content_type_2 = TP_WASM_MODULE_SECTION_GLOBAL_TYPE_I64;
    uint32_t mutability_2 = TP_WASM_MODULE_SECTION_GLOBAL_IMMUTABLE;
    uint32_t content_type_3 = TP_WASM_MODULE_SECTION_GLOBAL_TYPE_I64;
    ...
    payload_len += tp_make_i64_const_code(NULL, 0, (int64_t)heap_current);
    ...
    payload_len += tp_make_i64_const_code(NULL, 0, (int64_t)heap_base);
    payload_len += tp_make_end_code(NULL, 0);

    payload_len += tp_encode_ui32leb128(NULL, 0, content_type_3);
    payload_len += tp_encode_ui32leb128(NULL, 0, mutability_3);
    payload_len += tp_make_i64_const_code(NULL, 0, (int64_t)data_end);
    payload_len += tp_make_end_code(NULL, 0);
    ...
    index += tp_make_i64_const_code(section_buffer, index, (int64_t)heap_current);
    ...
    index += tp_make_i64_const_code(section_buffer, index, (int64_t)heap_base);
    index += tp_make_end_code(section_buffer, index);
    ...
    index += tp_make_i64_const_code(section_buffer, index, (int64_t)data_end);
