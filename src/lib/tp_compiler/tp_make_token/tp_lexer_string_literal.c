    ...
    TP_SYMBOL_TABLE* symbol_table, TP_INPUT_FILE* input_file, bool* is_match, bool* is_end_of_source_code)
{
    ...
    TP_CHAR8_T* string_literal_pos = NULL;
    bool is_end_logical_line = false;

    if ( ! tp_getchar_pos_of_physical_line(symbol_table, input_file, &string_literal_pos, &is_end_logical_line)){
    ...
    TP_CHAR8_T current_char[3] = { 0 };
    current_char[0] = *string_literal_pos;
    ...
    case 'U':
        ...
        current_char[1] = *string_literal_pos;
        break;
    default:
        break;
    }
...
//      break;
    case 'u':
        if ('8' == current_char[1]){
            ...
            current_char[2] = *string_literal_pos;
...
//      break;
    case '"':
        ...
        if (0 != current_char[2]){
            ...
            current = current_char[2];
            TP_APPEND_STRING_CHAR(symbol_table, input_file, current_char[2]);
        }
        if ( ! s_char_sequence(
            symbol_table, input_file, TP_SYMBOL_STRING_LITERAL,
    ...
    if (is_local_match){
        ...
        pp_token.member_symbol = TP_SYMBOL_STRING_LITERAL;
    ...
    TP_CHAR8_T current_char, bool* is_match)
{
    ...
    TP_CHAR8_T* s_char_sequence_pos = NULL;
    bool is_end_logical_line = false;
    bool is_local_match = false;
    ...
    for (;;){
        ...
        if ( ! tp_getchar_pos_of_physical_line(symbol_table, input_file, &s_char_sequence_pos, &is_end_logical_line)){
        ...
        current_char = *s_char_sequence_pos;
