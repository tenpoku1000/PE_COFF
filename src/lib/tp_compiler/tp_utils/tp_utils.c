...
{
    switch (log_type){
    case TP_LOG_TYPE_DEFAULT:         // PRINT & LOG
        break;
    case TP_LOG_TYPE_HIDE_AFTER_DISP: // ERROR
//      break;
    case TP_LOG_TYPE_DISP_FORCE:      // ERROR
        ++(symbol_table->member_error_count);
        break;
    case TP_LOG_TYPE_DISP_WARNING:    // WARNING
        ++(symbol_table->member_warning_count);
        break;
    case TP_LOG_TYPE_HIDE:            // LOG
        break;
    default:
        break;
    }
    ...
    bool is_disp = (
        ...
        (TP_LOG_TYPE_DISP_WARNING == log_type) ||
