...
#define TP_X64_REGISTER_ARGS 4

#define TP_X64_OPCODE_NOP 0x90
#define TP_X64_OPCODE_INT_3 0xcc
#define TP_X64_OPCODE_MOV_REG 0x8b
#define TP_X64_OPCODE_MOV_DST_MEM 0x89
#define TP_X64_OPCODE_MOV_SRC_MEM_REG (0x89 | 0x02)
#define TP_X64_OPCODE_ADD_REG 0x03
#define TP_X64_OPCODE_ADD_DST_MEM 0x01
#define TP_X64_OPCODE_ADD_SRC_MEM_REG (0x01 | 0x02)
#define TP_X64_OPCODE_SUB 0x2b
#define TP_X64_OPCODE_SUB_DST_MEM 0x29
#define TP_X64_OPCODE_SUB_SRC_MEM_REG (0x29 | 0x02)
#define TP_X64_OPCODE_IDIV_IMUL_EAX_1 0xf7
#define TP_X64_OPCODE_IMUL_EAX_2 0x5
#define TP_X64_OPCODE_IDIV_2 0x07
#define TP_X64_OPCODE_IMUL_1 0x0f
#define TP_X64_OPCODE_IMUL_2 0xaf
#define TP_X64_OPCODE_XOR 0x33
#define TP_X64_OPCODE_XOR_DST_MEM 0x31
#define TP_X64_OPCODE_XOR_SRC_MEM_REG (0x31 | 0x02)

#define TP_X64_OPCODE_MOV_IMM 0xb0 // (reg & 0x07)
#define TP_X64_OPCODE_MOV_IMM_32_64 (0xb0 | 0x08) // (reg & 0x07) 
#define TP_X64_OPCODE_MOV_IMM_MEM 0xc7
#define TP_X64_OPCODE_ADD_SUB_IMM8_1 0x83
#define TP_X64_OPCODE_ADD_SUB_IMM32_1 0x81
#define TP_X64_OPCODE_ADD_IMM8_IMM32_2 0xc0 // (reg & 0x07)
#define TP_X64_OPCODE_SUB_IMM8_IMM32_2 0xe8 // (reg & 0x07)
#define TP_X64_OPCODE_LEA 0x8d
#define TP_X64_OPCODE_PUSH 0x50 // (reg64 & 0x07)
#define TP_X64_OPCODE_POP 0x58 // (reg64 & 0x07)
#define TP_X64_OPCODE_JNE_REL8 0x75
#define TP_X64_OPCODE_JNE_REL32_1 0x0f
#define TP_X64_OPCODE_JNE_REL32_2 0x85
#define TP_X64_OPCODE_CALL_INDIRECT 0xff
#define TP_X64_OPCODE_CALL_RIP 0xe8
#define TP_X64_OPCODE_RET 0xc3
...
#define TP_X64_16_BYTES_ALIGNMENT 16
#define TP_X64_PADDING_16_BYTES_ALIGNMENT(value) (rsize_t)(-((int64_t)value) & (TP_X64_16_BYTES_ALIGNMENT - 1))
...
\
        TP_PUT_LOG_MSG( \
            ...
            TP_MSG_FMT("TP_X64_CHECK_CODE_ASSIGN(%1 function: %2): %3(%4), %5	%6"), \
            TP_LOG_PARAM_STRING(__func__), TP_LOG_PARAM_UINT64_VALUE(__LINE__), \
            TP_LOG_PARAM_STRING(#x64_code_size), TP_LOG_PARAM_UINT64_VALUE(x64_code_size), \
            TP_LOG_PARAM_STRING(#tmp_x64_code_size), TP_LOG_PARAM_UINT64_VALUE(tmp_x64_code_size), \
        ); \
...
#define TP_X64_CHECK_CODE_ASSIGN(symbol_table, x64_code_size, tmp_x64_code_size) \
\
    do{ \
        if (0 == (tmp_x64_code_size)){ \
\
...
typedef struct tp_wasm_stack_element_{
    ...
    bool member_is_tmp_reg;
    bool member_is_arg_of_nested_function;
...
typedef struct tp_x64_func_local_{
