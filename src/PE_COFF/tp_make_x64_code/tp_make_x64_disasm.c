...
/*
tp_make_x64_disasm.c(451): SUCCESS: push rbp, push rbp
tp_make_x64_disasm.c(451): SUCCESS: (bad), (bad)
tp_make_x64_disasm.c(451): SUCCESS: (unknown), (unknown)
tp_make_x64_disasm.c(451): SUCCESS: sub rsp,0x198, sub rsp,0x198
tp_make_x64_disasm.c(451): SUCCESS: lea rbp,[rsp+0x20], lea rbp,[rsp+0x20]
tp_make_x64_disasm.c(443): SUCCESS:
    mov QWORD PTR [rip+0xffffffffffffdff9],rdx, mov QWORD PTR [rip+0xffffffffffffdff9],rdx # 0xffffffffffffe000
tp_make_x64_disasm.c(443): SUCCESS:
    mov r8,QWORD PTR [rip+0xffffffffffffdff2], mov r8,QWORD PTR [rip+0xffffffffffffdff2] # 0xffffffffffffdff9
tp_make_x64_disasm.c(443): SUCCESS:
    lea rdx,[rip+0xffffffffffffefa0], lea rdx,[rip+0xffffffffffffefa0] # 0xffffffffffffefa7
tp_make_x64_disasm.c(451): SUCCESS: call rbx, call rbx
tp_make_x64_disasm.c(451): SUCCESS: mov rsi,rbp, mov rsi,rbp
tp_make_x64_disasm.c(451): SUCCESS: mov rdi,0x10, mov rdi,0x10
tp_make_x64_disasm.c(451): SUCCESS: add rsi,rdi, add rsi,rdi
tp_make_x64_disasm.c(451): SUCCESS: lea rdx,[rsi+none*1], lea rdx,[rsi+none*1]
tp_make_x64_disasm.c(451): SUCCESS: mov rsi,QWORD PTR [rdi+none*1+0x8], mov rsi,QWORD PTR [rdi+none*1+0x8]
tp_make_x64_disasm.c(451): SUCCESS: sub rax,r8, sub rax,r8
tp_make_x64_disasm.c(451): SUCCESS: jne 0xc0, jne 0xc0
tp_make_x64_disasm.c(451): SUCCESS: mov ecx,0x0, mov ecx,0x0
tp_make_x64_disasm.c(451): SUCCESS: mov r8,0x0, mov r8,0x0
tp_make_x64_disasm.c(451): SUCCESS: mov rdi,QWORD PTR [r10+none*1+0x68], mov rdi,QWORD PTR [r10+none*1+0x68]
tp_make_x64_disasm.c(451): SUCCESS: imul ecx, imul ecx
tp_make_x64_disasm.c(451): SUCCESS: imul ecx,edx, imul ecx,edx
tp_make_x64_disasm.c(451): SUCCESS: mov DWORD PTR [rbp+none*1+0x0],eax, mov DWORD PTR [rbp+none*1+0x0],eax
tp_make_x64_disasm.c(451): SUCCESS: mov edx,DWORD PTR [rbp+none*1+0x0], mov edx,DWORD PTR [rbp+none*1+0x0]
tp_make_x64_disasm.c(451): SUCCESS: mov DWORD PTR [rbp+none*1+0x4],eax, mov DWORD PTR [rbp+none*1+0x4],eax
tp_make_x64_disasm.c(451): SUCCESS: mov eax,DWORD PTR [rbp+none*1+0x4], mov eax,DWORD PTR [rbp+none*1+0x4]
tp_make_x64_disasm.c(451): SUCCESS: mov ecx,0x64, mov ecx,0x64
tp_make_x64_disasm.c(451): SUCCESS: add eax,ecx, add eax,ecx
tp_make_x64_disasm.c(451): SUCCESS: idiv ecx, idiv ecx
tp_make_x64_disasm.c(451): SUCCESS: xor eax,ecx, xor eax,ecx
tp_make_x64_disasm.c(451): SUCCESS: add rsp,0x50, add rsp,0x50
tp_make_x64_disasm.c(451): SUCCESS: pop rbp, pop rbp
tp_make_x64_disasm.c(451): SUCCESS: ret, ret
tp_make_x64_disasm.c(251): test_disasm: total(32), ok(32), ng(0)
*/
...
//  case TP_X64_OPCODE_XOR_SRC_MEM_REG: return "xor";
    ...
    if (TP_X64_OPCODE_IDIV_IMUL_EAX_1 ==
        ...
        switch (((*(disasm_params->member_x64_opcode_2)) & 0x38) >> 3){
