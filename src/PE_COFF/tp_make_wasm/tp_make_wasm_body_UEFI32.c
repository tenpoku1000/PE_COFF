...
// Member offset
static const uint32_t OFFSET_OF_ST_RuntimeServices = 0x38;
static const uint32_t OFFSET_OF_ST_ConIn = 0x24;
static const uint32_t OFFSET_OF_ST_ConOut = 0x2c;
static const uint32_t OFFSET_OF_OUT_OutputString = 0x4;
static const uint32_t OFFSET_OF_IN_ReadKeyStroke = 0x4;
static const uint32_t OFFSET_OF_RT_ResetSystem = 0x40;
...
static bool make_section_code_origin_wasm_UEFI32_code(
...
TP_WASM_MODULE_SECTION* tp_make_section_code_origin_wasm_UEFI32(TP_SYMBOL_TABLE* symbol_table)
{
    ...
    // (func $efi_main (type 0) (param i32 i32) (result i64)
    //   (local i32)
    size_t body_size = 0;

    if ( ! make_section_code_origin_wasm_UEFI32_code(symbol_table, NULL, &body_size)){
    ...
    if ( ! make_section_code_origin_wasm_UEFI32_code(symbol_table, section_buffer, &index)){
    ...
    TP_SYMBOL_TABLE* symbol_table, uint8_t* section_buffer, size_t* body_size)
{
    ...
    TP_WASM_CODE_PROLOGUE(symbol_table, index, tp_make_i32_const_code(section_buffer, index, 16));
    TP_WASM_CODE_PROLOGUE(symbol_table, index, tp_make_i32_sub_code(section_buffer, index));
    ...
    // ST = system_table;
    TP_WASM_CODE_REL32(
        symbol_table, index, tp_make_i32_const_code(
    ...
    TP_WASM_CODE(
        symbol_table, index, tp_make_i32_store_code(
            section_buffer, index, TP_WASM_MEM_ALIGN_32, 0
        )
    );
    ...
    TP_WASM_CODE_REL32(
        symbol_table, index, tp_make_i32_const_code(
            section_buffer, index, /* 1040 */OFFSET_OF_RT
    ...
    TP_WASM_CODE(
        symbol_table, index, tp_make_i32_load_code(
            section_buffer, index, TP_WASM_MEM_ALIGN_32, /* 0x38 */OFFSET_OF_ST_RuntimeServices
        )
    );
    TP_WASM_CODE(
        symbol_table, index, tp_make_i32_store_code(
    ...
    TP_WASM_CODE(
        symbol_table, index, tp_make_i32_load_code(
            section_buffer, index, TP_WASM_MEM_ALIGN_32, /* 0x24 */OFFSET_OF_ST_ConIn
        )
    );
    TP_WASM_CODE(
        symbol_table, index, tp_make_i32_store_code(
    ...
    TP_WASM_CODE(
        symbol_table, index, tp_make_i32_load_code(
            section_buffer, index, TP_WASM_MEM_ALIGN_32, /* 0x2c */OFFSET_OF_ST_ConOut
        )
    );
    TP_WASM_CODE(
        symbol_table, index, tp_make_i32_store_code(
    ...
    TP_WASM_CODE(
        symbol_table, index, tp_make_i32_load_code(
            section_buffer, index, TP_WASM_MEM_ALIGN_32, /* 0x4 */OFFSET_OF_OUT_OutputString
        )
    );
    ...
    TP_WASM_CODE(symbol_table, index, tp_make_i64_load_code(section_buffer, index, TP_WASM_MEM_ALIGN_64, 0));
    TP_WASM_CODE(
        symbol_table, index,
        tp_make_i64_store_code(section_buffer, index, TP_WASM_MEM_ALIGN_64, /* 8 */OFFSET_OF_LOCAL_STATUS)
    );
    ...
    TP_WASM_CODE(symbol_table, index, tp_make_loop_code(section_buffer, index, TP_WASM_BLOCK_TYPE_VOID));
        ...
        // &key
        TP_WASM_CODE_BASE(symbol_table, index, tp_make_get_local_code(section_buffer, index, 2));
        TP_WASM_CODE(symbol_table, index, tp_make_i32_const_code(section_buffer, index, /* 16 */OFFSET_OF_KEY));
        TP_WASM_CODE_ARG(
            symbol_table, index, tp_make_i32_add_code(section_buffer, index), 1, TP_WASM_RETURN_VOID
        );
        ...
        TP_WASM_CODE(
            symbol_table, index, tp_make_i32_load_code(
                section_buffer, index, TP_WASM_MEM_ALIGN_32, /* 0x4 */OFFSET_OF_IN_ReadKeyStroke
            )
        );
    ...
    // NULL
    TP_WASM_CODE_ARG(
        symbol_table, index, tp_make_i32_const_code(section_buffer, index, 0), 3, TP_WASM_RETURN_VOID
    );
    ...
    TP_WASM_CODE(
        symbol_table, index, tp_make_i32_load_code(
            section_buffer, index, TP_WASM_MEM_ALIGN_32, /* 0x40 */OFFSET_OF_RT_ResetSystem
        )
    );
    ...
    TP_WASM_CODE_EPILOGUE(symbol_table, index, tp_make_i32_const_code(section_buffer, index, 16));
    TP_WASM_CODE_EPILOGUE(symbol_table, index, tp_make_i32_add_code(section_buffer, index));
